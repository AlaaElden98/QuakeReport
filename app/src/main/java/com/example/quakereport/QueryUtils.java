    ...
    public static ArrayList<EarthquakeInfo> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); ++i) {
                ...
                EarthquakeInfo earthquakeInfo = new EarthquakeInfo(location, magnitude, time,url);
